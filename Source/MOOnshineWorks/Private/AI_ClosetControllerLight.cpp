...
AAI_ClosetControllerLight::AAI_ClosetControllerLight(const class FPostConstructInitializeProperties& PCIP)
	: Super(PCIP)
{

}

void AAI_ClosetControllerLight::AttackPlayer()
{
...
void AAI_ClosetControllerLight::SpeedUp()
{
	AAI_BasicEnemy* WalkingEnemy = (AAI_BasicEnemy*)GetPawn();
	WalkingEnemy->StartSprint();
}
void AAI_ClosetControllerLight::ClosetPatrol()
{
	APawn* MyBot = GetPawn();
	if (MyBot == NULL)
	{
