...
AAI_BarrelControllerLight::AAI_BarrelControllerLight(const class FPostConstructInitializeProperties& PCIP)
	: Super(PCIP)
{

}

void AAI_BarrelControllerLight::AttackPlayer()
{
...
void AAI_BarrelControllerLight::SpeedUp()
{
	AAI_BasicEnemy* WalkingEnemy = (AAI_BasicEnemy*)GetPawn();
	WalkingEnemy->StartSprint();
}
void AAI_BarrelControllerLight::BarrelPatrol()
{
	APawn* MyBot = GetPawn();
	if (MyBot == NULL)
	{
